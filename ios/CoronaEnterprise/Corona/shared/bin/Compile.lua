...
-- "$BUILDER_PATH" car "$CORONA_TARGET_EXECUTABLE_DIR/resource.car" "$CORONA_TARGET_EXECUTABLE_DIR"/*.lu
print( 'Archiving ' .. CORONA_TARGET_EXECUTABLE_DIR ..'/*.lu into ' .. CORONA_TARGET_EXECUTABLE_DIR .. '/resource.car' )
local result = os_execute( 
    'find -H',
	...
	escape( CORONA_TARGET_EXECUTABLE_DIR .. "/resource.car" ) )

checkError( 0 == result, "Failed to generate resource.car." )
