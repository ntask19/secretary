...
CORONA_API int CoronaLibraryNewWithFactory(
	lua_State *L, lua_CFunction factory, const luaL_Reg libFuncs[], void *context );
...
CORONA_API int CoronaLibraryProviderNew( lua_State *L, const char *libName, const char *providerName, const char *publisherId );
